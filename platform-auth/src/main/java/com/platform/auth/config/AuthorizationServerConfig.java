...
import com.platform.auth.extension.captcha.CaptchaTokenGranter;
import com.platform.auth.extension.mobile.SmsCodeTokenGranter;
import com.platform.auth.extension.refresh.PreAuthenticatedUserDetailsService;
import com.platform.auth.extension.wechat.WechatTokenGranter;
import com.platform.auth.userdetails.member.MemberUserDetailsServiceImpl;
import com.platform.auth.userdetails.user.SysUserDetailsServiceImpl;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public DefaultTokenServices tokenServices(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        clientUserDetailsServiceMap.put(SecurityConstants.WEBAPP_CLIENT_ID, memberUserDetailsService); // 微信小程序客户端
