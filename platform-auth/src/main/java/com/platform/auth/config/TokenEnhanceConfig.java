...
import com.platform.auth.userdetails.member.MemberUserDetails;
import com.platform.auth.userdetails.user.SysUserDetails;
...
/**
 * @ClassName TokenEnhanceConfig
 * @Description JWT Claim 内容增强
 * @Author hechunhui
 * @Date 2023/2/8 14:59
 * @Version 1.0
 */
