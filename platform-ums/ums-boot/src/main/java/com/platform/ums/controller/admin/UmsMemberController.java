package com.platform.ums.controller.admin;
...
public class UmsMemberController {
    ...
    @DeleteMapping("/{ids}")
    public <T> Result<T> delete(@ApiParam("会员ID，多个以英文逗号(,)拼接") @PathVariable String ids) {
    ...
    public Result<MemberInfoDTO> getMemberInfo(@ApiParam("会员ID") @PathVariable Long memberId) {
